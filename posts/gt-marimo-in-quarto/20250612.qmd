...
Here, I demonstrate how MMrimo widgets can be embedded in Great Tables by wrapping them with the `html()` function provided by the library. This allows interactive widgets to control the table's appearance in a Quarto environment via WASM — a surprisingly powerful capability, in my opinion.

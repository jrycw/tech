...
### Create a Slider to Navigate Table States
...
### Full marimo code
Check out the full marimo code below or view it on [molab](https://molab.marimo.io/notebooks/nb_FfAE5bVJ9P6DWDDy4Gng2h/app).
```{python}
#| code-fold: true
#| eval: false

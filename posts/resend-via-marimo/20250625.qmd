...
One challenge I ran into was figuring out how to securely set environment variables in marimo WASM environment—especially when it’s rendered inside a Quarto document.

Since the app resets every time the page reloads, everything starts from scratch. I needed to find a reliable way to set environment variables safely on each reload.

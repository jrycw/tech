...
This post demonstrates how to seamlessly integrate [Resend](https://resend.com/) with [django-allauth](https://docs.allauth.org/en/latest/). If you're looking to use `Resend` for sending emails via `Django`, refer to the [repo](https://github.com/resend/resend-django-smtp-example) provided by `Resend`.

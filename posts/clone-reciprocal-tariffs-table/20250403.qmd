...
7. The original table featured two rings, but I was only able to implement the inner one. To enhance the overall visual effect while adding the ring, I also inserted a row at the end of the table and filled it with the same background color.
    ...
    .cols_label(
        {
            ...
            "tariffs_charged": html(
                ...
                <span style="font-size: 12px;">\
                    Including<br>Currency Manipulation<br>and Trade Barrierst\
                </span>\
                """
            ),

...
(
    df.with_row_index(offset=1).with_columns(
        pl.col("").spt.binarize("blue", "yellow"),
...
Note: Since we're not using the actual column values in the custom logic, you can simply use `pl.col("")` as a placeholder to trigger the namespace methods.

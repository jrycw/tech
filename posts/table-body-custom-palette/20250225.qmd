---
title: "Applying Custom Color Palettes to Table Bodies in Great Tables"
...
This post provides a concise guide on styling table bodies with custom colors using Pandas and Polars.  
...
color_mapping = {"x": "lightgrey", "y": "papayawhip", "z": "lightblue"}
```
